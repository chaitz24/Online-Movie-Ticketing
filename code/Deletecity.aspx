<%@ Page Title="" Language="C#" MasterPageFile="~/MasterADMIN.master" AutoEventWireup="true" CodeFile="Deletecity.aspx.cs" Inherits="Deletecity" %>
                    ...
                    <tr>
                        <td align="center" class="style9" colspan="2">
                            ...
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Italic="True" 
                                ...
                                Text="Please Enter The Desired CITY NAME U Wana DELETE From Your Database..!!"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
