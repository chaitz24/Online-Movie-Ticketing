<%@ Page Title="" Language="C#" MasterPageFile="~/MasterADMIN.master" AutoEventWireup="true" CodeFile="deleteticketclass.aspx.cs" Inherits="deleteticketclass" %>
...
<table cellpadding="2" class="style7" align="center" style="width:600px" bgcolor="Blue">
        <tr>
            <td>
                    ...
                    <tr>
                        <td align="center" class="style9">
                            <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" 
                                Text="TICKET-CLASS NAME : "></asp:Label>
                        </td>
                        <td align="center" class="style9">
                    ...
                    <tr>
                        <td align="center" class="style9" colspan="2">
                            ...
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Italic="True" 
                                ...
                                Text="Please Enter The Desired CLASS NAME U Wana DELETE From Your Database..!!"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
