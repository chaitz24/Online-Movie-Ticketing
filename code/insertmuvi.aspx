<%@ Page Title="" Language="C#" MasterPageFile="~/MasterADMIN.master" AutoEventWireup="true" CodeFile="insertmuvi.aspx.cs" Inherits="insertmuvi" %>
                    ...
                    <tr>
                        <td align="center" class="style9" colspan="2">
                            ...
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Italic="True" 
                                ...
                                Text="Please Enter The Desired Movie Name U Wana Enter In Your Database..!!"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
